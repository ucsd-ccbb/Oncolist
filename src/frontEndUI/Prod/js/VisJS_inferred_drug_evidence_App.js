...
/*
                    ...
                    for (var property in $scope.allNodes) {
                        if ($scope.allNodes.hasOwnProperty(property)) {
                            if(nodePositions[property].y < max_y_pos){
                                max_y_pos = nodePositions[property].y;
                            }
                        }
                    }

                    max_y_pos = max_y_pos - 150;
                    console.log(max_y_pos);


                    $scope.nodes.add({id: 999999, label: 'legend', title: 'Testing', color: {'background':'#0C0C0C', 'border': '#E8FF00'}, permaColor: {'background':'#0C0C0C', 'border': '#FF0000'}, shape: 'dot', x: 0, y: max_y_pos, size: 40, permaSize: 40});
                    $scope.nodes.add({id: 999998, label: 'legend', title: 'Testing', color: {'background':'#0C0C0C', 'border': '#E8FF00'}, permaColor: {'background':'#0C0C0C', 'border': '#FF0000'}, shape: 'dot', x: -100, y: max_y_pos, size: 40, permaSize: 40});
                    $scope.nodes.add({id: 999997, label: 'legend', title: 'Testing', color: {'background':'#0C0C0C', 'border': '#E8FF00'}, permaColor: {'background':'#0C0C0C', 'border': '#FF0000'}, shape: 'dot', x: -200, y: max_y_pos, size: 40, permaSize: 40});
                    $scope.nodes.add({id: 999996, label: 'legend', title: 'Testing', color: {'background':'#0C0C0C', 'border': '#E8FF00'}, permaColor: {'background':'#0C0C0C', 'border': '#FF0000'}, shape: 'dot', x: -300, y: max_y_pos, size: 40, permaSize: 40});
                    $scope.network.fit();
*/
                }
            });
